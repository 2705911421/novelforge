...
class SimulationChapterIntentService:
    ...
    def create(self, proposal_id: str, *, chapter_number: int) -> ChapterIntent:
        ...
        intent = ChapterIntent(
            ...
            goals=list(self._values(payload, "goals", fallback=[row["summary"]] if row["summary"] else [row["title"]])),
            ...
            foreshadowing_to_advance=list(self._values(payload, "foreshadowingToAdvance", "foreshadowing_to_advance")),
            ...
            plot_threads=list(self._values(payload, "plotThreads", "plot_threads")),
